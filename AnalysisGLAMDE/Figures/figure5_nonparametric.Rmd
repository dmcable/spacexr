...
# Nonparametric GLAMDE on the Slide-seq KP tumor

### Load in GLAMDE Results and cluster significant genes
...
for(gene in sig_gene_list) {
  predictions <- predict_GLAMDE(2, gene_fits, gene, myRCTDde@internal_vars_de$X2[barc_list,])[,1]
...
for(gene in sig_gene_list) {
  predictions <- predict_GLAMDE(2, gene_fits, gene, new_X)[,1]
...
### Analyze variance explained by spatial GLAMDE model
