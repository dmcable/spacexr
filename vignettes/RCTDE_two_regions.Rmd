---
title: "Applying RCTDE to Spatial Transcriptomics Data: Two Regions"
author: "Dylan Cable"
...
output:
  ...
  rmarkdown::html_vignette:
    keep_md: yes
vignette: |
  %\VignetteIndexEntry{rctde-two-regions} 
...
two divide the cerebellum into two regions (left and right).

Here, we also artifically upregulate the expression of the Kcnip4 gene (in regions of high explanatory variable) to see whether RCTDE can detect this differentially expressed gene.
