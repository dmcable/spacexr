...
Now that we have successfully run RCTD, we can create a explanatory variable (i.e. covariate) used for predicting differential expression in RCTDE. In this case, the variable, `explanatory.variable`, will be randomly generated, but in general one should set the explanatory variable to biologically relevant predictors of gene expression such as spatial position.
...
Here, we also artifically upregulate the expression of the Lsamp gene (in regions of high explanatory variable) to see whether RCTDE can detect this differentially expressed gene.
