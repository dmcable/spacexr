---
title: "Applying GLAMDE to Spatial Transcriptomics Data"
author: "Dylan Cable"
...
Now that we have successfully run RCTD, we can create a explanatory variable (i.e. covariate) used for predicting differential expression in GLAMDE. In this case, the variable, `explanatory.variable`, will be randomly generated, but in general one should set the explanatory variable to biologically relevant predictors of gene expression such as spatial position.
...
Here, we also artifically upregulate the expression of the Lsamp gene (in regions of high explanatory variable) to see whether GLAMDE can detect this differentially expressed gene.
