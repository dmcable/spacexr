---
title: "Applying GLAMDE to Spatial Transcriptomics Data: Cell-to-cell interactions"
author: "Dylan Cable"
...
output:
  ...
  rmarkdown::html_vignette:
    keep_md: yes
vignette: |
  %\VignetteIndexEntry{GLAMDE-celltocell-interactions} 
...
constructs the design matrix for a single explanatory variable. After constucting the design matrix, one can use the `run.GLAMDE` function to run GLAMDE with this general design matrix.
