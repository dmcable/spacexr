---
title: "Applying RCTDE to Spatial Transcriptomics Data: Cell-to-cell interactions"
author: "Dylan Cable"
...
output:
  ...
  rmarkdown::html_vignette:
    keep_md: yes
vignette: |
  %\VignetteIndexEntry{rctde-celltocell-interactions} 
...
constructs the design matrix for a single explanatory variable. After constucting the design matrix, one can use the `run.RCTDE` function to run RCTDE with this general design matrix.
