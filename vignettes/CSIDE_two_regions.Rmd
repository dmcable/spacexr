---
title: "Applying CSIDE to Spatial Transcriptomics Data: Two Regions"
author: "Dylan Cable"
...
output:
  ...
  rmarkdown::html_vignette:
    keep_md: yes
vignette: |
  %\VignetteIndexEntry{CSIDE-two-regions} 
...
print(file.path(savedir,'myRCTD.rds'))
...
myRCTD <- run.CSIDE.single(myRCTD, explanatory.variable, gene_threshold = .01, 
                         cell_type_threshold = 3, fdr = 0.25, cell_types = cell_types) 
