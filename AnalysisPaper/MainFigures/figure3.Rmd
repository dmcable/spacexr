...
square_results[1,] <- (square_results[1,] + square_results[2,])/2
square_results[3,] <- (square_results[3,] + square_results[4,])/2
square_results[7,] <- (square_results[7,] + square_results[8,])/2
square_results[9,] <- (square_results[9,] + square_results[10,])/2
...
```{r fig.height = 4, fig.width = 4, fig.align = 'center'}
load(file = "../Plotting/Results/decompose.RData")
my_pal = pals::coolwarm(20)
