...
marker_data_de <- marker_data_de[!(marker_data_de$cell_type %in% c("Interneuron","Neurogenesis")) | (rownames(marker_data_de) %in% de_genes_spec),]
saveRDS(marker_data_de, '../../Data/SpatialRNA/Puck_200115_08/results/marker_data_de.RDS')
```
...
marker_data_de <- readRDS('../../Data/SpatialRNA/Puck_200115_08/results/marker_data_de.RDS')
