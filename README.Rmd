...
1. Within the 'RCTD_base' folder, open the 'spatial-transcriptomics.Rmd' vignette in 'RStudio.' Run it for a complete explanation of the RCTD workflow. Expected output of the vignette is provided [here](https://raw.githack.com/dmcable/RCTD/master/vignettes/spatial-transcriptomics.html). 
