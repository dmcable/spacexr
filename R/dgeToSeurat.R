library(Seurat)
mydir <- "/Users/dcable/Documents/MIT/Research/Rafalab/Projects/slideseq/Cell Demixing"
refdir <- paste(mydir,"Data/KidneyHumanReference",sep="/")
source(file.path(mydir,"utils.R"))
...
reference = CreateSeuratObject(raw.data, meta.data = meta_data)
