...
#' Constructs a design matrix for running GLAMDE with a single explanatory variable
#'
...
#' @return A design matrix containing the covariates for running GLAMDE. The rownames represent pixel names and
...
#' Constructs a design matrix for running GLAMDE nonparametrically
#'
...
#' Constructs a design matrix for running GLAMDE across a set of regions
#'
